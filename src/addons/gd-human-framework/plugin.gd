...
func _enter_tree() -> void:
	...
	clothes_editor = add_control_to_bottom_panel(load("res://addons/gd-human-framework/technical/editor/char_edit_editor.tscn").instantiate(), "Change morphs/clothes")
